...
const DockingEntry = () => {
    ...
    useEffect(() => {
        ...
        axios.all([
            axios.get("http://localhost:5000/dockingEntryAuth/manufacturer", { headers: { Authorization: `Bearer ${authToken}` } }),
            axios.get("http://localhost:5000/dockingEntryAuth/product", { headers: { Authorization: `Bearer ${authToken}` } })
        ])
    ...
    const handleSubmit = (e) => {
        ...
        axios.post("http://localhost:5000/dockingEntryAuth/dockingentry", dockingEntry)
            .then(() => {
